...
import moodishcomm.comm.ServerSideMessage.Type;

import moodishsecurity.securityfilter.exceptions.SecurityFilterClientBlockException;
import moodishsecurity.securityfilter.records.SecurityFilterClients;
...
public class MoodishSecurityFilter extends ServerCommDecorator {	
	...
	private enum Messages {
	    FIRST_WARNING("WARNING: You repeatedly changed mood at least 8 times within a span of "+firstTimeSpan+" seconds!"),
